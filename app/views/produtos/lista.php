            ...
            <tbody>
                <?php foreach ($produtos as $produto): ?>
                    <tr>
                        ...
                        <td>
                            <form action="index.php?rota=adicionar_carrinho" method="POST" class="d-inline">
                                <input type="hidden" name="produto_id" value="<?= $produto['id'] ?>">
                                <input type="number" name="quantidade" value="1" class="form-control d-inline w-25" min="1">
